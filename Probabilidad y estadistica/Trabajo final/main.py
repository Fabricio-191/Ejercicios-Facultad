...
print('H0: var = 30,   H1: var > 30      ', variance_test(30, 'greater'))
print('H0: var = 20,   H1: var < 20      ', variance_test(20, 'less'))
print('H0: var = 28,   H1: var != 28     ', variance_test(27.97649, 'two-sided'))
print()
...
# test de independencia usando el coeficiente de correlacion de Spearman usando 5 intervalosde igual tamaño
